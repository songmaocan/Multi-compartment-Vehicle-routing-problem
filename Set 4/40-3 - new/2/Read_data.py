...
class Read_txt:
    def __init__(self,based_profit):
        ...
        # self.g_number_of_vehicles=13
        self.vehicle_arrival_time_ending=2000
        print("Reading data...")
    ...
    def generate_links(self):
        ...
        self.g_number_of_links += 1
        self.output_file()
        self.generate_number_of_vehicles()
    ...
    def generate_number_of_vehicles(self):
        vehicle_number_for_commodities=[]
        for c in range(self.g_number_of_commodities):
            demand_c=0
            for node_id in range(1,self.g_number_of_nodes-1):
                demand_c+=self.node_list[node_id].demand[c]
            vehicle_num_c=math.ceil(demand_c/self.compartment_capacity)
            vehicle_number_for_commodities.append(vehicle_num_c)
        self.g_number_of_vehicles=max(vehicle_number_for_commodities)
    ...
    def generate_GAMS_file(self):
        with open("GAMS_input.txt", "w") as fl:
            ...
            fl.write("destination_node(v,'{}','{}') = 1;\n".format(self.virtural_depot, self.vehicle_arrival_time_ending))
